...
const Card: React.FC<CardProps> = ({ name, address, pincode, phone, imageUrl }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border rounded shadow">
    ...
    <div className="flex flex-col items-center mt-4 sm:mt-0 sm:ml-4">
      ...
      <button className="bg-blue-500 text-white px-4 py-2 rounded mt-2 sm:mt-4 w-full sm:w-auto">Get Directions</button>
    </div>
  </div>
  );
};
